            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        logger_1.default.info(normalizedMessages);
                    ...
                    case 5:
                        e_1 = _a.sent();
                        logger_1.default.error(e_1.stack);
                        return [3 /*break*/, 6];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_2 = _a.sent();
                        logger_1.default.error("error en connect: " + err_2.message, err_2.stack);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        logger_1.default.info('setMessage');
                        logger_1.default.error(obj);
                        return [4 /*yield*/, mongoMensajes_1.DBService.insert(obj)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, obj];
