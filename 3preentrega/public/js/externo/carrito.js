const agregarCarrito = (id) => {
    const url = `http://tercera-pre.herokuapp.com/api/carrito/agregar/` 
...
const borrarCarrito = async (id_producto) => {
  const url = `http://tercera-pre.herokuapp.com/api/carrito/borrar/` 
...
const fetchCarrito = () => {
    const url = 'http://tercera-pre.herokuapp.com/api/carrito/listar';
...
function deleteAll() {
  fetch('http://tercera-pre.herokuapp.com/api/carrito/borrar/todo', {
    method: 'DELETE',
    mode: 'cors'
  })
    .then(response => response.json())
