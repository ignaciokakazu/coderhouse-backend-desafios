...
var productos_1 = require("../persistencia/productos");
var classProductos = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, productos_1.DBService.getAll()];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        _b = (_a = res).json;
                        return [4 /*yield*/, productos_1.DBService.getProductById(id)];
                    case 2:
                        _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 4];
                    case 3:
    ...
    classProductos.prototype.addProducto = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var requestBody, nombre, price, thumbnail, stock, descripcion, category_id, prodTemp, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, productos_1.DBService.insert(prodTemp)];
                    case 2:
                        _a.sent();
                        res.json(prodTemp);
                        return [3 /*break*/, 4];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, productos_1.DBService.delete(id)];
                    case 2:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, productos_1.DBService.update(id, prodTemp)];
                    case 2:
                        _a.sent();
                        res.json(prodTemp);
                        return [3 /*break*/, 4];
