...
const getProductos = async () => {
  const data = await _fs.default.promises.readFile('./productos.txt', 'utf-8');
...
app.get('/items/', async (request, response) => {
  ...
  const cantidadProd = dataJson.length; //Martín: hay alguna forma más 'bonita' de hacer esto? Para crear el objeto con variables...
